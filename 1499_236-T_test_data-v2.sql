...
/* block for insert row in CUST, ACCT, WIRE_TRXN
 *
 */
DECLARE
...
/* start test data for BUSINESS.CUST */
 ...
 inn_arr inn_arr_arrType		--! < indexed array for variable test data
 inn_arr('cust_1_1') := '7743123450';	--! < valid for test case, Customer-1
 inn_arr('cust_2_1') := '7743123470';	--! < not valid for test case, Customer-2
 inn_arr('cust_3_1') := '9932456780';	--! < not valid for test case, Customer-3
/* end test data for BUSINESS.CUST */
/* start test data for BUSINESS.ACCT */
  /* variable data for specific test case */
 TYPE alt_acct_id_arrType IS TABLE OF varchar2(50)
  INDEX BY varchar2(20);
 alt_acct_id_arr alt_acct_id_arrType	--idexed array for list of the account number linked to the client (order by prmry_cust_intrl_id)
 alt_acct_id_arr('cust_1_1') := '40501810877771200000';	--! < valid for test case, Customer-1
 alt_acct_id_arr('cust_1_2') := '40502810877771300000';	--! < valid for test case, Customer-1
 alt_acct_id_arr('cust_1_3') := '40503810877771400000';	--! < valid for test case, Customer-1
 alt_acct_id_arr('cust_1_4') := '40504810877771500000';	--! < valid for test case, Customer-1
 alt_acct_id_arr('cust_1_5') := '40505810877771600000';	--! < valid for test case, Customer-1
 alt_acct_id_arr('cust_1_6') := '40605810877770960000';	--! < valid for test case, Customer-1
 alt_acct_id_arr('cust_1_7') := '40701810877770701000';	--! < valid for test case, Customer-1
 alt_acct_id_arr('cust_1_8') := '40702810877770702000';	--! < valid for test case, Customer-1
 alt_acct_id_arr('cust_1_9') := '40703810877770703000';	--! < valid for test case, Customer-1
 alt_acct_id_arr('cust_1_10') := '40704810877770704000';	--! < valid for test case, Customer-1
 alt_acct_id_arr('cust_1_11') := '40705810877770705000';	--! < valid for test case, Customer-1
 alt_acct_id_arr('cust_1_12') := '40802810877770802000';	--! < valid for test case, Customer-1
